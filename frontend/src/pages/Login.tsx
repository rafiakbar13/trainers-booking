...
const Login = () => {
  ...
  return (
    <section className="bg-gray-20">
      <article className="flex items-center justify-center w-5/6 h-screen mx-auto">
        <div className="flex bg-white shadow-xl w-[1920px] rounded-lg">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <form
              onSubmit={onSubmit}
              className="flex flex-col items-center w-full mt-4 gap-y-3"
            >
              <input
                type="text"
              ...
              <input
                ...
                onChange={handleInputChage}
              />
              <button className="text-white bg-gray-500 py-[15px] px-[35px] rounded-md mt-4 w-96 text-center">
                {loading ? (
                  <HashLoader
                    size={35}
                    color="#FF6B66"
