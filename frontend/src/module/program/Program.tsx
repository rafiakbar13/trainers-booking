            ...
            <div className='w-5/6 mx-auto'>
                <div className='flex items-center justify-between'>
                    <div className='relative'>
                        <h2 className='absolute text-gray-600 text-8xl text-opacity-10 -top-9 -left-40'>Program</h2>
                ...
                <div className='grid grid-cols-1 gap-4 mt-10 sm:grid-cols-2 md:grid-cols-3'>
                    {ProgramData.map((program, index) => (
                        <ProgramCard key={index} icon={program.icon} program={program.program} description={program.description} />
                    ))}
                </div>
            </div>
        </section>
