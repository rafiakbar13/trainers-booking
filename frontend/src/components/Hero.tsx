        ...
        <div className="mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-base">
              Discover your path to fitness with our comprehensive platform,
              designed to guide and support you on your wellness journey.
              Whether you're an exercise enthusiast or just starting out, we're
              here to assist you in finding the perfect fitness routine, expert
              trainers, and resources tailored to your needs.
            </p>
          </motion.div>
          {/* Action button */}
          <motion.div
          ...
          >
            ...
            <div className="relative flex items-center">
              ...
              <Video isOpen={isOpen} videoUrl={videoUrl} onClose={closeModal} />
