...
const Program = () => {
  return (
    <section className="h-full bg-gray-20">
      {/* section heading */}
      <div className="w-5/6 py-10 pb-0 mx-auto my-20">
        <div className="flex items-center justify-between">
          <div className="relative">
            <h2 className="absolute text-gray-600 text-8xl text-opacity-10 -top-9 -left-40">
              Program
            </h2>
