...
const Contact = () => {
    return (
        <section className="mt-20">
            <div className="max-w-screen-md px-4 mx-auto py-10">
                ...
                <form action="" className="space-y-8">
                    <div>
                        <label htmlFor="email" className="font-semibold text-[16px] leading-7 mb-2l">
                            Your Email
                        </label>
                        <input
                            type="email"
                    ...
                    <div>
                        <label htmlFor="subject" className="font-semibold text-[16px] leading-7 mb-2">
                            Subject
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="message" className="font-semibold text-[16px] leading-7 mb-2">
                            Your Message
                        </label>
                        <textarea
                            rows={6}
                    ...
                    <button type="submit" className="rounded py-[15px] px-[35px]  text-white font-[600] mt-[38px] sm:w-full bg-gray-500">
                        Submit
                    </button>
                </form>
            </div>
