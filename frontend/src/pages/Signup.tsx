        ...
        <section className="">
            <div className="w-5/6 mx-auto">
                <div className="flex justify-center items-center h-screen">
                    <div className="grid grid-cols-1 w-96 bg-white shadow-lg rounded-lg mx-auto">
                        {/* SIGNUP FORM */}
                        <div className="py-10 px-5 rounded-lg h-auto  ">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="mb-5">
                                    ...
                                    />
                                    {errors.name?.message && <p className="text-red-500 text-[14px]">{`${errors.name.message}`}</p>}
                                </div>
                                <div className="mb-5">
                                    <input
                                        {...register("email")}
                                        ...
                                        className="w-full px-4 py-3 border border-solid border-gray-500 rounded-md text-[16px] text-primary-500 font-[400] focus:outline-none focus:border-primary-500 leading-7 placeholder:text-gray-50 cursor-pointer"
                                    />
                                    {errors.email?.message && <p className="text-red-500 text-[14px]">{`${errors.email.message}`}</p>}
                                </div>
                                <div className="mb-5">
                                    <input
                                        {...register("password")}
                                    ...
                                    />
                                    {errors.password?.message && <p className="text-red-500 text-[14px]">{`${errors.password.message}`}</p>}
                                </div>
                                ...
                                <button type="submit" disabled={isLoading} className='text-white bg-gray-500 py-[15px] px-[35px] rounded-md mt-4 w-full'>{isLoading ? <HashLoader size={35} color="#FF6B66" /> : "Signup"}</button>
                                <div>
